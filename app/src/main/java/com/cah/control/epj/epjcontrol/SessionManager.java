...
public class SessionManager {
    ...
    // IdUsuario (make variable public to access from outside)
     ...
     * */
    public void createLoginSession(String name, String email, String IdUsuario){
