...
import com.cah.control.epj.epjcontrol.CustomAdapter.CustomAdapter;
import com.cah.control.epj.epjcontrol.CustomAdapter.RowItem;
...
//        menu.findItem(R.string.action_settings).setVisible(!drawerOpen);
    ...
    protected void onDestroy() {
        Log.w("APPDESTROY ", "App destroyed");
